...
for stock_id in stock_list:
    for strategy in strategy_list:   
        ...
        #df2 = pd.read_csv('./data/Input/' + stock_id + '_input_train_' + str(day_length) + "_nochip" + '.csv',header=None)
        df2 = pd.read_csv('./data/Input/' + stock_id + '_input_train_' + str(day_length) + "_NEW" + '.csv',header=None)
        #df2 = pd.read_csv('./data/Input/' + stock_id + '_input_test_' + str(day_length) + "_NEW2" + '.csv',header=None)
        ...
        gail_trainer.gen_algo.save("./model/Expert_" + strategy + "_" + stock_id + "_" + str(day_length) + "_final_10")
